...
<body>
    <form class="form-signin" method="post">
        ...
        <input type="email" id="inputEmail" class="form-control mb-4" placeholder="email" name="email" required autofocus>
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if (!empty($_POST['email']) && !empty($_POST['password'])) { //se la variabile mail o password che devono essere inviate non sono vuote all'ora si invia
                ...
                if ($res == -1) {
                    ...
                    window . location . replace("https://dispersione.violamarchesini.it/pages/homepage.php");</script>';
                }
            } else {
