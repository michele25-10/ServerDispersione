    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold text-white-50"
                        href="https://dispersione.violamarchesini.it/pages/archivioAlunni.php">Alunni</a>
                </li>
            </ul>
...
<script>
function logout() {
    console.log("SOno dentro questa funzione");
    sessionStorage.clear();
    window.location.replace("https://dispersione.violamarchesini.it/index.php");
}
</script>