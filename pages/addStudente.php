...
<body>
    ...
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" onkeyup="this.value = this.value.toUpperCase();" id="SIDI" placeholder="Codice SIDI" name="SIDI" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Telefono studente</label>
        ...
        //invio dei dati alla funzione addAlunno per aggiungere un alunno nel DB
