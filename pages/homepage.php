...
<body>
                    ...
                    <tbody>
                        <?php foreach ($list_corsi as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <button id="edit" class="btn btn-primary me-1 mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="onClick(<?php echo $row['id'] ?>)">Modifica</button>
                                    <button id="delete" type="button" data-bs-toggle="modal" data-bs-target="#elimina<?php echo $row['id']; ?>" class="btn btn-danger me-1 mb-2">
    ...
    <div class=" modal fade" id="exampleModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($res == 1) {
                echo '<script>window . location . replace("https://dispersione.violamarchesini.it/pages/homepage.php");</script>';
            }
        }
        ?>
